...
def get_expenses(current_user_id):
    try:
        ...
        if start_date_str or end_date_str:
            ...
            if end_date_str:
                try:
                    # To include the entire end date, we set it to the very end of that day (23:59:59)
...
def add_expense(current_user_id):
    try:
        ...
        try:
            ...
            try:
                # Fallback if full ISO timestamp is sent
...
def update_expense(current_user_id, id):
    try:
        ...
        # Retrieve existing expense to verify ownership
        try:
...
def delete_expense(current_user_id, id):
    try:
        ...
        # Perform deletion checking user_id ownership
